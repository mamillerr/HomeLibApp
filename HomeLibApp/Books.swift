...
struct Book {
    ...
    static func getBook() -> [Book] {
        [
            ...
            Book(name: "451 Градус по Фаренгейту", author: "Рэй Брэдбери", genre: "Филосовский роман", pubHouse: "The Planet", translator: "В. Бабенко", status: "В процессе чтетия", location: "На тумбочке", image: "Фаренгейт")
